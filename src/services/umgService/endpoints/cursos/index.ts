...
class CursosService {
  ...
  getCursos = async (): Promise<Cursos> => {
    try {
      const response = await fetch('https://apiumgcollab.onrender.com/api/Cursos', {
        method: 'GET',
        headers: {
  ...
  updateCurso = async (id: number, cursoData: Partial<Cursos>): Promise<void> => {
    ...
    try {
      const response = await fetch(`https://apiumgcollab.onrender.com/api/Cursos/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  getCursoExcelId = async (id: number): Promise<Blob> => {
    try {
      const response = await fetch(`https://apiumgcollab.onrender.com/api/Cursos/${id}/excel`, {
        method: 'GET',
        headers: {
  ...
  getCursoExcel = async (): Promise<Blob> => {
    try {
      const response = await fetch('https://apiumgcollab.onrender.com/api/cursosExcel', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
        },
  ...
  getCursoPdf = async (): Promise<Blob> => {
    try {
      const response = await fetch('https://apiumgcollab.onrender.com/api/cursosPdf', {
        method: 'GET',
        headers: {
...
getCursoPdfById = async (id: number): Promise<Blob> => {
  try {
    const response = await fetch(`https://apiumgcollab.onrender.com/api/cursos/${id}/pdf`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/pdf',
      },
